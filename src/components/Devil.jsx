...
const photos = [
   ...
   // { img: "/47.jpg", featured: false },
   // { img: "/48.jpg", featured: false },
   ...
   // { img: "/65.jpg", featured: false },
   { img: "/66.jpg", featured: false },
   { img: "/67.jpg", featured: false },
   // { img: "/68.jpg", featured: false },
